...
import math
import random as rd
from testTheta import ThetaStarPathPlanner


def main():
    # planner = ThetaStarPathPlanner(robot_radius=0.4)
    # start = (5.0, 3.0)
    # goal = (2.0, 14.0)
    # path = planner.theta_star(start, goal)
    ...
    # PATH.append((pts[-1][0], pts[-1][1], 120))
